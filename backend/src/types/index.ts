// Shared types for Tax Nexus application
...
export interface CreateReturnsFoldersRequest {
  folderPaths: string[];
}
...
export interface MoveReturnFilesRequest {
  folderPaths: string[];
}
...
export interface DeleteReturnFoldersRequest {
  folderPaths: string[];
}
